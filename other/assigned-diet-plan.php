                ...
                <div class="col-lg-8">
                  <div class="page-header-title">
                    ...
                    <div class="d-inline">
                      ...
                      <span>Displaying all the previous records of Diet Plans Assigned</span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                  <?php
                                  // Query to get all from animals_dietplan table and get animals and dietplan data from animals and dietplan tables
                                  $sql = "SELECT ad.id, ad.date, ad.cost, ad.quantity, ad.a_id, ad.d_id, a.Id, a.Name AS a_Name, a.Age, a.Gender, a.Temperature, a.Price, a.Pregnant, a.Breed, a.Date, a.`Diet plan`, a.Quantity, a.Cost AS a_Cost, a.`milk production` AS a_MP, a.DateM, a.CostM, a.grp, d.Id, d.Name AS d_Name, d.Milkproduction AS d_MP, d.Foarges, d.FQuantity, d.FCost, d.Proteins, d.PQuantity, d.PCost, d.Minvit, d.MQuantity, d.MCost, d.Cost AS d_Cost FROM animals_dietplan AS ad INNER JOIN animals AS a ON ad.a_id = a.Id INNER JOIN dietplan AS d ON ad.d_id = d.Id";
                                  $result = $conn->query($sql);
