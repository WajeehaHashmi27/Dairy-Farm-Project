                  ...
                  <div class="col-lg-8">
                    ...
                    <i class="feather icon-pie-chart bg-c-blue"></i>
                      <div class="d-inline">
                        <h5>Notifications</h5>
                        <span
                          >Displaying all Notifications</span
                        >
                      </div>
                    </div>
                  </div>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<form method='post' action='update-not.php' style='display: inline-block;'>";
        echo "<input type='hidden' name='id' value='" . $row['Id'] . "'>";
        echo "<button type='submit' class='btn btn-primary btn-sm' name='update-status'>Mark as read</button>";
        echo "</div>";
        echo "</td>";
        echo "<td>";
        echo "<div class='btn-group' role='group'>";
        echo "<a href='delete-not.php?id=" . $row['Id'] . "' class='btn btn-danger btn-sm btn-delete' data-id='" . $row['Id'] . "'>Delete</a>";
        echo "</form>";
        echo "</div>";
        echo "</td>";
        echo "</tr>";
