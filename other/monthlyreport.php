                ...
                <div class="col-lg-8">
                  <div class="page-header-title">
                    ...
                    <div class="d-inline">
                      ...
                      <span>Displaying the Monthly Report</span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
                              ...
                              <div class="col-xl-12">
                                <div class="card proj-progress-card">
                                  <div class="card-block">
                                    <div class="row">
                                      <?php
                                      $values_sql = "SELECT a.Id as a_Id, a.Name as a_Name, a_mp.date AS date, SUM(a_mp.quantity) AS sum_pm_kg, a_mp.total_cost AS pm_amount, SUM(a_dp.quantity) AS sum_fc_kg, a_dp.cost AS fc_c, SUM(a_mp.total_cost - a_dp.cost) AS pl, AVG(a_mp.total_cost - a_dp.cost) AS pl_avg FROM `animals_milkproduction` AS a_mp INNER JOIN animals_dietplan AS a_dp ON a_mp.a_id = a_dp.a_id INNER JOIN animals AS a ON a_mp.a_id = a.Id WHERE a_mp.date = a_dp.date ORDER BY date DESC";
                                      $values_result = $conn->query($values_sql);
                                      $row = $values_result->fetch_assoc();
                                      ?>
                                      <div class="col-xl-3 col-md-6">
                                        <h6>Total Feed Quantity</h6>
                                        <h5 class="m-b-30 f-w-700"><span class="text-c-red m-l-10"><?php echo $row['sum_fc_kg'] ?> kg</span></h5>
                                        <div class="progress">
                                          <div class="progress-bar bg-c-red" style="width:25%"></div>
                                        </div>
                                      </div>
                                      <div class="col-xl-3 col-md-6">
                                        <h6>Total Milk Quantity</h6>
                                        <h5 class="m-b-30 f-w-700"><span class="text-c-blue m-l-10"><?php echo $row['sum_pm_kg'] ?> kg</span></h5>
                                        <div class="progress">
                                      ...
                                      <div class="col-xl-3 col-md-6">
                                        ...
                                        <h5 class="m-b-30 f-w-700"><span class="text-c-green m-l-10"><?php echo $row['pl'] ?></span></h5>
                                        <div class="progress">
                                      ...
                                      <div class="col-xl-3 col-md-6">
                                        <h6>Average</h6>
                                        <h5 class="m-b-30 f-w-700"><span class="text-c-yellow m-l-10"><?php echo $row['pl_avg'] ?></span></h5>
                                        <div class="progress">
                              ...
                              <table id="simpletable" class="table table-striped table-bordered nowrap">
                                <thead>
                                  <tr>
                                    ...
                                    <th>Name</th>
                                    <th>Date</th>
                                    <th>Produced Milk kg</th>
                                    <th>Produced Milk Amount</th>
                                    <th>Feed Consumed kg</th>
                                    <th>Feed Consumed Cost</th>
                                    <th>Profit/Loss</th>
                                ...
                                <tbody>
                                  <?php
                                  // get data from animals_milkproduction table join with animals table and animals_dietplan table
                                  $sql = "SELECT a.Id as a_Id, a.Name as a_Name, a_mp.date AS date, a_mp.quantity AS pm_kg, a_mp.total_cost AS pm_amount, a_dp.quantity AS fc_kg, a_dp.cost AS fc_c FROM `animals_milkproduction` AS a_mp INNER JOIN animals_dietplan AS a_dp ON a_mp.a_id = a_dp.a_id INNER JOIN animals AS a ON a_mp.a_id = a.Id WHERE a_mp.date = a_dp.date ORDER BY date DESC";
                                  $result = $conn->query($sql);
                                  ...
                                  if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                      ...
                                      echo "<td>" . $row['date'] . "</td>";
                                      echo "<td>" . $row['pm_kg'] . "</td>";
                                      echo "<td>" . $row['pm_amount'] . "</td>";
                                      echo "<td>" . $row['fc_kg'] . "</td>";
                                      echo "<td>" . $row['fc_c'] . "</td>";
                                      echo "<td>" . $row['pm_amount'] - $row['fc_c'] . "</td>";
