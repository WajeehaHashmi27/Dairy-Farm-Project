...
<html lang="en">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      href="../files/assets/pages/waves/css/waves.min.css"
      type="text/css"
      media="all"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="../files/assets/icon/themify-icons/themify-icons.css"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="../files/assets/icon/font-awesome/css/font-awesome.min.css"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="../files/assets/css/pages.css"
    />
  </head>
              ...
              <div class="pcoded-inner-content">
                <div class="main-body">
                  <div class="page-wrapper">
                    <div class="page-body" style=" display: inline-block; width: 270px;">
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <figure>
                            <img src="../files/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image" style="width: auto; height: 150px; margin-left:40px">
                            <figcaption style=" margin-left:30px ;margin-top:30px;font-weight: bold;" >Admin of CATTLEHUB</figcaption>
</figure>
                    ...
                    <div class="col-xl-10 col-md-12" style="display: inline-block; width: 70%;">
...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Output the HTML table row with the dynamic data
        echo '<tr>';
        echo '<td><h4>Name:</h4></td>';
        echo '<td class="text-right"><h5>' . $name . '</h5></td>';
        echo '</tr>';

        echo '<tr>';
        echo '<td><h4>Id:</h4></td>';
        echo '<td class="text-right"><h5>' . $id . '</h5></td>';
        echo '</tr>';

        echo '<tr>';
        echo '<td><h4>Email:</h4></td>';
        echo '<td class="text-right"><h5>' . $email . '</h5></td>';
        echo '</tr>';

        echo '<tr>';
        echo '<td><h4>Phone no:</h4></td>';
        echo '<td class="text-right"><h5>' . $phone . '</h5></td>';
        echo '</tr>';
    }
...
?>
    ...
    <script
      type="text/javascript"
      src="../files/bower_components/modernizr/js/css-scrollbars.js"
    ></script>
