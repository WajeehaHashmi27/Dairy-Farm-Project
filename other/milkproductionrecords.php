                ...
                <div class="col-lg-8">
                  <div class="page-header-title">
                    ...
                    <div class="d-inline">
                      ...
                      <span>Displaying all the previous records of Milk Production </span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
                            ...
                            <div class="dt-responsive table-responsive">
                              <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                  ...
                                  $sql = "SELECT * FROM `animals_milkproduction` INNER JOIN animals ON animals_milkproduction.a_id = animals.Id";
                                  $result = $conn->query($sql);
